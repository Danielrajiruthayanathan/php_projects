            ...
            <form action="sreg.php" method="POST">
              ...
              <div class="row">
                ...
                <div class="col-md-6 mb-4 pb-2">
                  ...
                  <div class="form-outline">
                    <input type="number" name="pno"class="form-control form-control-lg" maxlength="10" required="1"/>
              ...
              <div class="row">
                <div class="col-12">
                  ...
                  <select  name=""class="select form-control-lg">
                    <option value="1" disabled>Choose option</option>
                    <option name="sub" value="tamil">tamil</option>
                    <option name="sub" value="english">english</option>
                    <option name="sub" value="mathis">mathis</option>
                  </select>
